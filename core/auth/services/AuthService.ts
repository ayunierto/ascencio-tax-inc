...
interface AuthServiceInterface {
  signUp(newUser: SignUpApiRequest): Promise<SignUpResponse>;
...
export class AuthService implements AuthServiceInterface {
   ...
   */
  public async signUp(newUser: SignUpApiRequest): Promise<SignUpResponse> {
  ...
  public async deleteAccount(
    ...
    try {
      return await httpClient.delete<DeleteAccountResponse>(
        'auth/delete-account',
        {
  ...
  public async updateProfile(
    ...
    try {
      return await httpClient.patch<UpdateProfileResponse>(
        'auth/update-profile',
        {
